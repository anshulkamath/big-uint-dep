...
def create_test_cases():
    ...
    with open(test_file, 'w+', newline='') as out:
        out.write('void test_big_uint_gcd_extended() {\n')
        out.write('\ttesting_logger_t *tester = create_tester();\n')
        out.write('\tuint32_t result_x[5] = { 0 };\n')
        out.write('\tuint32_t result_y[5] = { 0 };\n')
        out.write('\n')

    generate_test_case(1, 1, 1, a=143, b=234)
    generate_test_case(2, 1, 1, 1)
    generate_test_case(3, 2, 1, 1)
    generate_test_case(4, 2, 2, 2)
    generate_test_case(5, 2, 1, 2)
    generate_test_case(6, 2, 2, 1)
    generate_test_case(7, 3, 3, 3)
    generate_test_case(8, 3, 3, 3)
    generate_test_case(9, 3, 1, 2)
    generate_test_case(10, 3, 1, 1)
